...
python3.11 -m uvicorn users.main:app --host 0.0.0.0 --port 8002 --reload &
USER_PID=$!

# Start Academic Service on port 8003
echo "Starting Academic Service on port 8003..."
python3.11 -m uvicorn academic.main:app --host 0.0.0.0 --port 8003 --reload &
ACADEMIC_PID=$!
...
python3.11 -m uvicorn learning.main:app --host 0.0.0.0 --port 8004 --reload &
LEARNING_PID=$!


# Start Payment Service on port 8005
echo "Starting Payment Service on port 8005..."
python3.11 -m uvicorn payment.main:app --host 0.0.0.0 --port 8005 --reload &
PAYMENT_PID=$!
...
python3.11 -m uvicorn gateway.main:app --host 0.0.0.0 --port 8000 --reload &
GATEWAY_PID=$!
